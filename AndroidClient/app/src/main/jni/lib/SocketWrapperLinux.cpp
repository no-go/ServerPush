...
int SocketWrapper::getPort(void) {
	socklen_t len = sizeof(_address);
	getsockname(_socket, (struct sockaddr *) &_address, &len);
	return ntohs(_address.sin_port);
}

int SocketWrapper::getPeerPort(void) {
	socklen_t len = sizeof(_address);
	getpeername(_socket, (struct sockaddr *) &_address, &len);
	return ntohs(_address.sin_port);
}
